...
public class FlatShooterTuning extends ShooterTuning {
    ...
    private static final double touchingHangtime[] = { 1.4, 1.4, 1.4 } ;
    ...
    private static final double lowHangtime[] = { 1.4, 1.4, 1.4, 1.4 } ;
    ...
    private static final double medHangtime[] = { 1.4, 1.4, 1.4 } ;
