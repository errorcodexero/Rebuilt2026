...
public class climberIOTalonFX implements climberIO {
    ...
    public climberIOTalonFX(int armID, int elevatorID){
        deployMotor= new TalonFX(armID);
        deployClimb  = new TalonFX(elevatorID);
    ...
    public void ClimberIOTalonFX() {
        //arm motor configuration 
         deployMotor= new TalonFX(climberconstants.MotoroneID); 
        ...
        deployClimb  = new TalonFX(ClimberConstants.MotortwoID);
        ...
        tryUntilOk(5, () -> deployClimb .getConfigurator().apply(armConfig, 0.25));
