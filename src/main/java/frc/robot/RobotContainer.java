...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser_.addOption("Depot Collect to NZ Collect- Depot Top to Top NZ", AutoCommands.a3DepotShootNZ(drivebase_, intake_, hopper_, shooter_, false));
        autoChooser_.addOption("Depot Collect to NZ Collect- Depot Bottom to Bottom NZ", AutoCommands.a3DepotShootNZ(drivebase_, intake_, hopper_, shooter_, true));
