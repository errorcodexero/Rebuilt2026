...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser_.addOption("Neutral Zone Collect - Left Trench", AutoCommands.NZCollectAuto(drivebase_, shooter_, intake_, hopper_, false));
        autoChooser_.addOption("Neutral Zone Collect - Right Trench", AutoCommands.NZCollectAuto(drivebase_, shooter_, intake_, hopper_, true));
