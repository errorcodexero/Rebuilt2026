...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser_.addOption("Right Trench To Left Trench", AutoCommands.a1TrenchToTrench(drivebase_, intake_, hopper_, shooter_, trues));
        ...
        autoChooser_.addOption("Depot Collect to NZ Collect- Depot Top to NZ", AutoCommands.a3DepotShootNZ(drivebase_, intake_, hopper_, shooter_, false));
        autoChooser_.addOption("Depot Collect to NZ Collect- Depot Bottom to NZ", AutoCommands.a3DepotShootNZ(drivebase_, intake_, hopper_, shooter_, true));
